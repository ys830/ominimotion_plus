...
from loaders.create_training_dataset_self import get_training_dataset
from trainer_self import BaseTrainer
...
def train(args):
    ...
    log_dir = 'logs_self_p6/{}_{}'.format(args.expname, seq_name)
