...
if __name__ == '__main__':
    ...
    # dataset_name = 'davis'  # specify dataset name, davis or kinetics or rgb_stacking
    # folder_path = './tapvid_davis_256'  # specify the path of the downloaded ckpts/annotations for the corresponding dataset
    # ckpt_dir = '{}/ckpts'.format(folder_path) 
    # annotation_dir = '{}/annotations'.format(folder_path)
    # seq_names = os.listdir(ckpt_dir)
    # out_dir = 'tapvid_{}_eval_out'.format(dataset_name)

    # for seq_name in seq_names:
    #     args.data_dir = os.path.join(ckpt_dir, seq_name)
    #     args.ckpt_path = os.path.join(ckpt_dir, seq_name, 'model_200000.pth')
    #     eval_one_sequence(args, annotation_dir, dataset_name, seq_name, out_dir=out_dir)

    # summarize(out_dir, dataset_name)
